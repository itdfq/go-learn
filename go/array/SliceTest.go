...
func main() {
	...
	printSlice(numbers) //len=10 cap=18 slice=[0 1 2 3 4 5 6 7 8 250]
	/* 同时添加多个元素 */
	numbers = append(numbers, 2, 3, 4)
	printSlice(numbers) //len=13 cap=18 slice=[0 1 2 3 4 5 6 7 8 250 2 3 4]

	/* 创建切片 numbers1 是之前切片的两倍容量*/
	numbersx := make([]int, len(numbers), (cap(numbers))*2)

	/* 拷贝 numbers 的内容到 numbers1 */
	copy(numbersx, numbers)
	printSlice(numbersx) //len=13 cap=36 slice=[0 1 2 3 4 5 6 7 8 250 2 3 4]
